...
motor_in1_pin = 22 #R_EN
motor_in2_pin = 23 #L_EN
RPWM = 19
LPWM = 26
...
io.setup(RPWM, io.OUT)
io.setup(LPWM, io.OUT)
...
rpwm = io.PWM(RPWM, 800)
lpwm = io.PWM(LPWM, 800)
...
def exit():
   ...
   io.output(motor_in2_pin, False)
   io.cleanup()
   # Hier wird das PWM Signal der Kanaele auf 0 gesetzt.
   rpwm.ChangeDutyCycle(0)
   lpwm.ChangeDutyCycle(0)
